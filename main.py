...
def main():
    ...
    thicc = Thicc()
    spain = BuenosDias()
    reverte = ReverteReact()
    reverted = RevertedReact()
    # TODO
    #gracias = Gracias()
    #habeces = AVeces()
    ...
    updater.dispatcher.add_handler(MessageHandler(spain, BotActions.spain))
    updater.dispatcher.add_handler(MessageHandler(reverte, BotActions.reverte))
    updater.dispatcher.add_handler(MessageHandler(reverted, BotActions.reverted))
    # TODO
